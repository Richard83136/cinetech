window.addEventListener('DOMContentLoaded',(event) => {
    ...
    let apiKey = '258b640efb42e5a09e4f03e4b6d5c892';
        ...
        fetch(api_base_url + 'movie/top_rated?api_key=' + apiKey + '&language=fr-FR')
            ...
            for (let i = 0; i < 5; i++) {
                if(top_movie[i].poster_path != null){
                    ...
                    film.innerHTML = `<a href="vue/detail.php?movie=${top_movie[i].id}"><img src="${image_base_url + top_movie[i].poster_path}" class="img-fluid" ><br>
                    <span class="head_card">${top_movie[i].release_date}</span><br><span> Avis : ${top_movie[i].vote_average}</span></a>`
